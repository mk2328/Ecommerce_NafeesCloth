...
<script>
    function updateCheckoutSummary() {
        ...
        var subtotalElement = orderTableBody.querySelector(".checkoutarea__item:nth-child(2) .checkoutarea__cgt__des");
        var totalElement = orderTableBody.querySelector(".prc-total");
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        document.getElementById("checkoutForm").addEventListener("submit", function(event) {
            ...
            // Send form data + cart data via AJAX
            let formData = new FormData(this);
            formData.append("cart", JSON.stringify(cart)); // Convert cart to JSON
